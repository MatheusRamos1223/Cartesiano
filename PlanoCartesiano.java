...
public class PlanoCartesiano {
    ...
    public static void main(String[] args) {
        ...
        /*
        Repositório que armazena todos os pontos criados.
         ele utiliza um ArrayList<PontoNomeado>.
        */
        PontosRepositorio pr = new PontosRepositorio();
        PontoNomeado pontoAtual = pr.getOrigem();
        ...
        while(op != true){
            ...
            System.out.println("\n\t\t======================PLANO CARTESIANO======================");
            System.out.print("\t\t\t\t Ponto Atual - " + pontoAtual.getNome()  + "(" + pontoAtual.getX() + "," + pontoAtual.getY() + ")");
            System.out.println("\n\t\t============================================================");
            System.out.print("""
                             \t\t\t1 - Criar Coordenada
            ...
            switch(escolha){
                ...
                case 4 -> { 
                    ...
                    */
                    ...
                    PontoNomeado destEncontrado = pr.buscar(buscaDest);
                ...
                case 5 -> {
                    ...
                    for(PontoNomeado pLista : pr.listarPontos()){
                        pLista.exibirPontos();
                    }
                    ...
                    PontoNomeado encontrado = pr.buscar(busca);
                ...
                case 7 -> {
                    ...
                    PontoNomeado removido = pr.deletar(buscaDel);
                    
                    if(removido != null){
                        if(removido == pontoAtual){//caso o cara apague  o ponto atual
                            pontoAtual = pr.getOrigem();
                        }
                        System.out.println("Coordenada: " + removido.getNome()+ removido.toString() + " Deletada com Sucesso!");
                    }else{
